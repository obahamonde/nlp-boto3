...
export default defineConfig({
  shortcuts: [
    ...
    [
      "text-title",
      "font-script text-accent dark:text-light text-2xl text-center",
    ],
    ["text-body", "font-serif text-info dark:text-light text-lg"],
    [
      "text-subtitle",
  ...
  theme: {
    colors: {
      primary: "#5DBC47ff", // get primary light
      secondary: "#2D2F38", // post secondary success
      accent: "#973ac3", // put warning accent
      ligth: "#CFFAFE", // delete danger warning
      warning: "#F5A800",
      danger: "#ff0055",
      info: "#000000",
      success: "#CCFFCC",
